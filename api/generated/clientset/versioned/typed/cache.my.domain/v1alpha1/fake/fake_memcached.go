...
import (
	...
	v1alpha1 "github.com/example-inc/lib-go-plugin-operator/api/cache.my.domain/v1alpha1"
...
var memcachedsResource = schema.GroupVersionResource{Group: "cache.my.domain", Version: "v1alpha1", Resource: "memcacheds"}

var memcachedsKind = schema.GroupVersionKind{Group: "cache.my.domain", Version: "v1alpha1", Kind: "Memcached"}
