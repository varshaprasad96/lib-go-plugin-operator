...
import (
	...
	cachemydomainv1alpha1 "github.com/example-inc/lib-go-plugin-operator/api/cache.my.domain/v1alpha1"
	versioned "github.com/example-inc/lib-go-plugin-operator/api/generated/clientset/versioned"
	internalinterfaces "github.com/example-inc/lib-go-plugin-operator/api/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/example-inc/lib-go-plugin-operator/api/generated/listers/cache.my.domain/v1alpha1"
...
func NewFilteredMemcachedInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&cachemydomainv1alpha1.Memcached{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cachemydomainv1alpha1.Memcached{}, f.defaultInformer)
}
